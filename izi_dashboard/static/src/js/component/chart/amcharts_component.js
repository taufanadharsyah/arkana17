class amChartsComponent {
    constructor(attr){
        ...
        this.startZero = attr.startZero;
        this.maxAxisValue = attr.maxAxisValue;
    ...
    configShowAxisValue(valueAxis) {
        ...
        if (self.maxAxisValue != 0 && self.maxAxisValue != null && self.maxAxisValue != undefined) {
            valueAxis.max = self.maxAxisValue;
        }
    }
